...
export default function ListingCard({ title, price, location, image, category, isNew }: ListingCardProps) {
    return (
        <Card className="overflow-hidden border-border/40 hover:shadow-lg transition-all group cursor-pointer bg-card">
            <div className="relative aspect-[4/3] w-full overflow-hidden bg-muted">
                ...
                <div className="absolute top-3 right-3">
                    <Button size="icon" variant="secondary" className="h-8 w-8 rounded-full bg-white/80 backdrop-blur-sm hover:bg-white hover:text-red-500">
