...
export default function SellerMessagesPage() {
    ...
    // In a real app, we would filter for conversations where the user is the seller
        ...
        <div className="min-h-screen bg-background pb-32">
            ...
            <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-xl border-b border-border/40 px-6 py-4">
                <div className="flex items-center justify-between mb-4">
                    <h1 className="text-2xl font-bold tracking-tight">Sales inbox</h1>
                </div>
                ...
                <div className="relative group">
                    ...
                    <Input
                        ...
                        className="w-full bg-muted/50 border-none rounded-xl pl-10 h-11 transition-all font-medium"
                    />
                </div>
            </header>
                ...
                <div className="divide-y divide-border/40">
                    {filteredConversations.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0 pr-4">
                                    ...
                                    <p className={cn(
                                        ...
                                        {conv.last_message.sender_id === "user_me" && "You: "}
                        ...
                        <div className="py-20 text-center px-6">
                            ...
                            <h3 className="text-lg font-bold">No active sales</h3>
                            <p className="text-muted-foreground text-sm">Chats from interested buyers will appear here.</p>
                        </div>
                    )}
                </div>
            </main>
